  ...
  return (
    <SearchProvider posts={posts}>
      <PageLayout>
        ...
        <Section className="bg-gradient-to-b from-mainColor/10 to-transparent border-b border-border">
          <div className="mb-8">
        ...
        {/* CTA Section */}
        <Section className="bg-gradient-to-r from-mainColor/10 to-mainColor/5 border-t border-border">
          <div className="text-center">
