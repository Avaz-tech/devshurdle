...
export default function AboutPage() {
  ...
  return (
    <PageLayout>
      ...
      {/* Vision Section */}
      <Section className="bg-gradient-to-r from-mainColor/10 to-mainColor/5 border-y border-border">
        <div className="text-center">
      ...
      {/* CTA Section */}
      <Section className="bg-gradient-to-r from-mainColor to-mainColor/80 text-white py-16">
        <div className="text-center">
